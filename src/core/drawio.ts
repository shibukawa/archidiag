...
export function buildDrawioXml(model: RenderModel): string {
  ...
  model.nodes.forEach((node) => {
    ...
    const description = model.view.displayMode === 'descriptive' && node.element.description ? `&lt;br&gt;&lt;font style=&quot;font-size:9px&quot;&gt;${attr(node.element.description)}&lt;/font&gt;` : ''
  ...
  model.edges.forEach((edge) => {
    ...
    const label = edge.relationship.technology ? `${labelText}&lt;br&gt;&lt;font style=&quot;font-size:9px&quot;&gt;[${attr(edge.relationship.technology)}]&lt;/font&gt;` : labelText
    const dashed = edge.relationship.projected ? 'endFill=0;' : ''
